...
def calibration(avg_dif):
    ...
    video_capcal = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\calibration\Capture_cal.mp4', fourcc_capcal, 30, (640, 360))

    video_bin_dif = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\calibration\Capture_bindif.mp4', fourcc_capcal, 30, (640, 360))
    video_edge_dif = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\calibration\Capture_edgedif.mp4', fourcc_capcal, 30, (640, 360))
    video_deltadif = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\calibration\Capture_deltadif.mp4', fourcc_capcal, 30, (640, 360))

    video_bin_msk = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\calibration\Capture_binmsk.mp4', fourcc_capcal, 30, (640, 360))
    video_edge_msk = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\calibration\Capture_edgemsk.mp4', fourcc_capcal, 30, (640, 360))
    video_pick_msk = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\calibration\Capture_pick_msk.mp4', fourcc_capcal, 30, (640, 360))

    video_bin_line = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\calibration\Capture_bin_line.mp4', fourcc_capcal, 30, (640, 360))
    video_hor_line = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\calibration\Capture_hor_line.mp4', fourcc_capcal, 30, (640, 360))
    video_dil_line = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\calibration\Capture_dil_line.mp4', fourcc_capcal, 30, (640, 360))
    video_cls_line = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\calibration\Capture_cls_line.mp4', fourcc_capcal, 30, (640, 360))
    video_opn_line = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\calibration\Capture_opn_line.mp4', fourcc_capcal, 30, (640, 360))
...
def Excel_write_calibration(x_list_dif, y_list_dif, w_list_dif, h_list_dif, 
    ...
    wb = openpyxl.load_workbook(R'C:\Users\admin\Desktop\data\Readbook\excel_data\calibration.xlsx')
    wb.create_sheet('calibration_Readbook_1204-3')
    ws = wb['calibration_Readbook_1204-3']
    ...
    wb.save(R'C:\Users\admin\Desktop\data\Readbook\excel_data\calibration.xlsx')
    wb.close()
...
def Detection_data_excel(grad_val, grad_time, grad_delta, 
    ...
    wb = openpyxl.load_workbook(R'C:\Users\admin\Desktop\data\Readbook\excel_data\detection.xlsx')
    wb.create_sheet('detection_Readbook_1204-3')
    wb.create_sheet('detection_all_data_Readbook_1204-3')
    wb.create_sheet('gradients coordinates_Readbook_1204-3')
    ws_detection = wb['detection_Readbook_1204-3']
    ws_alldata = wb['detection_all_data_Readbook_1204-3']
    ws_gradcoord = wb['gradients coordinates_Readbook_1204-3']
    ...
    wb.save(R'C:\Users\admin\Desktop\data\Readbook\excel_data\detection.xlsx')
    wb.close()
...
def Detection_data_excel_ver2(time_cal_list, grad_cal_list, 
    ...
    wb = openpyxl.load_workbook(R'C:\Users\admin\Desktop\data\Readbook\excel_data\detection.xlsx')
    wb.create_sheet('detection_Readbook_1204-3')
    ws = wb['detection_Readbook_1204-3']
...
if __name__ == '__main__':
    ...
    video_cap = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\detection\Capture.mp4', fourcc_cap, 30, (640, 360))
    video_cut = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\detection\Capture_cut.mp4', fourcc_cap, 30, (cutsize_x, cutsize_y))
    video_msk = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\detection\Capture_msk.mp4', fourcc_cap, 30, (cutsize_x, cutsize_y))
    video_knl = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\detection\Capture_knl.mp4', fourcc_cap, 30, (cutsize_x, cutsize_y))
    video_dil = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\detection\Capture_dil.mp4', fourcc_cap, 30, (cutsize_x, cutsize_y))
    video_cls = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\detection\Capture_cls.mp4', fourcc_cap, 30, (cutsize_x, cutsize_y))
    video_opn = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\detection\Capture_opn.mp4', fourcc_cap, 30, (cutsize_x, cutsize_y))
    video_dlt = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\detection\Capture_dlt.mp4', fourcc_cap, 30, (cutsize_x, cutsize_y))
    video_dlt_bin = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\detection\Capture_dlt_bin.mp4', fourcc_cap, 30, (cutsize_x, cutsize_y))
    video_gau = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\detection\Capture_gau.mp4', fourcc_cap, 30, (cutsize_x, cutsize_y))
    video_gry = cv2.VideoWriter(R'C:\Users\admin\Desktop\data\Readbook\video_data\detection\Capture_gry.mp4', fourcc_cap, 30, (cutsize_x, cutsize_y))
