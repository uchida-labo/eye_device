...
while True:
    ...
    rotation_matrix = cv2.getRotationMatrix2D((320, 240), 30, 1.0)
    ...
    result += rotatedroi
    cutresult = result[50:250, 200:600]

    cv2.rectangle(frame, topleft, bottomright, (0, 0, 255), 2)
    # cv2.rectangle(result, topleft, bottomright, (255, 0, 0), 2)

    cv2.circle(frame, (320, 240), 2, (0, 255, 0), 2)
    cv2.circle(rotatedroi, (200, 150), 2, (0, 255, 0), 2)
    cv2.circle(cutresult, (200, 100), 2, (0, 255, 0), 2)

    # print('rotation roi = ', rotatedroi.shape)
    ...
    cv2.imshow('rotation roi', rotatedroi)
