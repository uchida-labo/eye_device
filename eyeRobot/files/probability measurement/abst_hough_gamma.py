...
# HoughCircle
circle = cv2.HoughCircles(fil, cv2.HOUGH_GRADIENT, 1.04, 100, param1=88, param2=81, minRadius=0, maxRadius=0)
...
#cv2.imwrite('hough_gamma.png', img)
cv2.imwrite('hgfil.png', fil)