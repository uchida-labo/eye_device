...
def draw(video, point, radius):
    ...
    r = int(radius)
    cv2.circle(video, pts, r, (0, 0, 255), 2)
    #cv2.putText(video, pts, (point[0]+5, point[1]+50), fontType, 1, (0, 255, 0),3)
...
while True:
    ...
    # ２値化
    ptyle = p_tile_threshold(gray, 0.056)
    fil = cv2.GaussianBlur(ptyle, (5, 5), 0)      #平滑化
