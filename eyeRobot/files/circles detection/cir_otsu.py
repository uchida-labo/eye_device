...
while True:
    ...
    th, frame_th_otsu = cv2.threshold(gray, 128, 255, cv2.THRESH_OTSU)

    #ハフ変換による円検出
    circle = cv2.HoughCircles(frame_th_otsu, cv2.HOUGH_GRADIENT, 0.9, 90, param1=100,\
                                         param2=65, minRadius=0, maxRadius=0)
