...
# camera setting
cap2 = cv2.VideoCapture(1) # mac:2  USB camera:0+cv2.CAP_DSHOW
cap2.set(cv2.CAP_PROP_FOURCC, cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'))
cap2.set(cv2.CAP_PROP_FPS, 30) # FPS setting
cap2.set(cv2.CAP_PROP_FRAME_WIDTH, 540) # width setting  1280pxel
cap2.set(cv2.CAP_PROP_FRAME_HEIGHT, 360) # height setting  720pxel
...
# excel sheet setting
# sheetname = 'Normal_front'   # ← Editing section
